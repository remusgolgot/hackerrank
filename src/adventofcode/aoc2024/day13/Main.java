...
//            System.out.println("NEW GAME");
            ...
            int ax = Integer.parseInt(ss[i].split("X+")[1].split(",")[0]);
            int bx = Integer.parseInt(ss[i + 1].split("X+")[1].split(",")[0]);

            int ay = Integer.parseInt(ss[i].split("Y+")[1]);
            int by = Integer.parseInt(ss[i + 1].split("Y+")[1]);

            int px = Integer.parseInt(ss[i + 2].split("X=")[1].split(",")[0]);
            int py = Integer.parseInt(ss[i + 2].split("Y=")[1]);
...
//            System.out.println(py);
    ...
    private static int calculateMe(int ax, int ay, int bx, int by, int px, int py) {
