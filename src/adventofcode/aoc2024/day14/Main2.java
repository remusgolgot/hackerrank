...
public class Main2 {
    ...
    public static void main(String[] args) {
        ...
        // calculate minimum sf across all seconds (loops around after width*length)
        int minSf = Integer.MAX_VALUE;
        int minIteration = 0;
        for (int k = 0; k < length * width; k++) {
            int[][] mat1 = new int[width][length];
...
//            System.out.println(sf);
        ...
        System.out.println(minIteration + 1);
