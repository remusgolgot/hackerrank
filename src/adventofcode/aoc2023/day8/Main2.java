...
public class Main2 {
    ...
    public static void main(String[] args) {
        ...
        for (String pfq : map.keySet()) {
            if (pfq.endsWith("A")) {
                points.add(pfq);
            }
        }
        String[] pArr = points.toArray(new String[0]);
        int[] pArrSteps = new int[pArr.length];
        ...
        // solution is the least common multiple (lcm) of the numbers from pArrSteps
        // lazy, so I dont feel the need to write lcm with BigDecimals
        // so I used an online lcm calculator
        // solutionLCM = 11283670395017
