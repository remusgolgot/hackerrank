            ...
            for (int j = 0; j < tt.length; j++) {
                ...
                for (int k = 0; k < zz.length; k++) {
                    ...
                    if (cube[1].equals("red")) {
                        if (Integer.parseInt(cube[0]) > minRed) {
                            minRed = Integer.parseInt(cube[0]);
                        }
                    }
                    if (cube[1].equals("green")) {
                        if (Integer.parseInt(cube[0]) > minGreen) {
                            minGreen = Integer.parseInt(cube[0]);
                        }
                    }
                    if (cube[1].equals("blue")) {
                        if (Integer.parseInt(cube[0]) > minBlue) {
                            minBlue = Integer.parseInt(cube[0]);
                        }
                    }
                }
            }
            sol += (minBlue * minRed * minGreen);
        }
